...
pub trait Writable<C: Context> {
    ...
    #[inline]
    fn write_to_buffer(&self, buffer: &mut [u8]) -> Result<usize, C::Error>
    where
    ...
    where
        ...
        C: Default,
    {
        self.write_to_buffer_with_ctx_mut_and_size(&mut Default::default(), buffer, bytes_needed)
    }
    ...
    fn write_to_buffer_with_ctx_mut(
        ...
        self.write_to_buffer_with_ctx_mut_and_size(context, buffer, bytes_needed)
    }

    #[inline]
    fn write_to_buffer_with_ctx_mut_and_size(
        &self,
        context: &mut C,
        buffer: &mut [u8],
        bytes_needed: usize,
